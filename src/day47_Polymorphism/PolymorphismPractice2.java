...
public class PolymorphismPractice2 {
    ...
    public static void main(String[] args) {
        ...
        Employee[] employees = {
                new Tester("Sherali", 32, 'M',"QA",1,  110000),
                new Developer("Zuhal", 27, 'F', "Java Developer",2,  128000),
                new Tester("George", 28,'M', "SDET",3,  120000),
                new Developer("Cristina", 23, 'F',"Software Developer",4,  135000),
                new Tester("Cihad", 30, 'M',"SDET",5,  105000),
                new Developer("Gulistan",  26, 'F',"Web Developer",6,  130000),
                new Tester("Yuliya",  28, 'F',"QE",7,  120000),
                new Developer("Cassendra",  29, 'F',"Front-end Developer",8,  140000),
                new Tester("Aygu",  25, 'F',"SDET",9,  130000),
                new Developer("Sophie",  26, 'F',"Back-end Developer", 10, 150000),
                new Tester("Timur",  29, 'M',"SDET",11,  115000),
                new Developer("Fady",  26, 'F',"Full Stack Developer",12,  142000),
                new Tester("Iryna",  24, 'F',"QE",13,  125000),
                new Developer("Enes",  26, 'M',"Full Stack Developer",14,  142000),
                new Tester("Mikael",  30, 'M',"SDET",15,  105000),
        };
